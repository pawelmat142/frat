        ...
        <>
            ...
            <div className="form-view relative">
                ...
                <div className="flex gap-5 justify-center">
                    ...
                    <div className="p-tile square-tile p-5 col-tile w-32 bottom-bar-shadow" onClick={() => handleGoogleSignIn()}>
                        <GoogleIcon size={iconSize} />
                        <div className="mt-1">Google</div>
                    </div>

                    <div className="p-tile square-tile p-5 col-tile w-32 bottom-bar-shadow" onClick={() => handleTelegramSignIn()}>
