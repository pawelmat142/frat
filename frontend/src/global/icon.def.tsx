...
import { FaBan, FaBell, FaBookmark, FaBriefcase, FaCalendarAlt, FaCheck, FaChevronRight, FaCog, FaComments, FaDownload, FaEdit, FaEllipsisV, FaFilter, FaGlobe, FaHome, FaIdCard, FaMapMarker, FaMapMarkerAlt, FaMarker, FaPaperPlane, FaPhone, FaPlus, FaRegClock, FaRegCompass, FaRegEnvelope, FaRulerVertical, FaSearch, FaSignInAlt, FaSignOutAlt, FaSlidersH, FaStar, FaTags, FaTimes, FaTrash, FaUserCircle, FaUserFriends, FaUserPlus } from "react-icons/fa";
