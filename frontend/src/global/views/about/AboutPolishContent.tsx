...
interface AboutPolishContentProps {
    isDesktop: boolean;
}

const AboutPolishContent: React.FC<AboutPolishContentProps> = ({ isDesktop }) => (
    <>
        ...
        <section className="card p-4 sm:p-6">
            ...
            <ul className="primary-color list-disc pl-5 space-y-2">
                <li className="list-disc"><span className="secondary-text">Techników z konkretnymi uprawnieniami, na przykład IRATA lub SPRAT, oraz doświadczeniem.</span></li>
                <li className="list-disc"><span className="secondary-text">Informacje o ważności certyfikatów, zakresie prac, językach i gotowości do wyjazdu.</span></li>
                <li className="list-disc"><span className="secondary-text">Wyszukiwanie po okolicy, dostępności i kwalifikacjach — gdy potrzebujesz wsparcia w krótkim terminie.</span></li>
                <li className="list-disc"><span className="secondary-text">Specjalistów na krótkie zlecenie, do stałej ekipy albo na dłuższy kontrakt.</span></li>
            </ul>
        </section>
...
export default AboutPolishContent;